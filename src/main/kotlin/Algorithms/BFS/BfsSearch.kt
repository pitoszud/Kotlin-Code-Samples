...
private fun populateB(graph: Graph<String>) {
    graph.apply {
        ...
        println(breadthFirstTraversal(graph, "you"))


        println(breadthFirstTraversal(graph, "you", 1))

        println("depth first search traversal")
        println(depthFirstTraversal(graph, "you"))

    }
}

private fun populateA(graph: Graph<String>) {
    graph.apply {
        // Node / vertex "0"
        addEdge("0", "1")
        addEdge("0", "4")
