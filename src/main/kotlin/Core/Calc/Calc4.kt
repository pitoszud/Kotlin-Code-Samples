...
class Calc4{
    ...
    companion object {
        ...
        private fun delWorstMod(){
            ...
            //Log.d(TAG, "L2")
            //if (statusL2Under120.isNotEmpty()){ Log.d(TAG, statusL2Under120) }
            //level2ModListDel.forEach { Log.d(TAG, it.toString()) }

            //level2ModListRem.forEach { Log.d(TAG, it.toString()) }

            //Log.d(TAG, "L3")
            //if (statusL3Under120.isNotEmpty()){ Log.d(TAG, statusL3Under120) }
            //level3ModListDel.forEach { Log.d(TAG, it.toString()) }

            //level3ModListRem.forEach { Log.d(TAG, it.toString()) }
